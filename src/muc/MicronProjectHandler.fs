...
type MicronProjectHandler() =
    ...
    interface IProjectHandler with
        ...
        member this.GetPassPreferences(log : ICompilerLog) : PassPreferences =
            ...
            passManager.RegisterMethodPass(
                PassInfo<IStatement * IMethod * ICompilerLog, IStatement>(
                        VerifyingDeadCodePass.NoMissingReturnInstance,
            ...
            // -freturn-motion will make -ftail-recursion far more effective.
            // Enable it at -O1 or above.
            passManager.RegisterPassCondition(
                PassCondition(ReturnMotionPass.ReturnMotionPassName, fun optInfo -> optInfo.OptimizeMinimal))
